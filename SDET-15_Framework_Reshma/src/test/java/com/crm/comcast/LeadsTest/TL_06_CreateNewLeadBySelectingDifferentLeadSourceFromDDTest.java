...
public class TL_06_CreateNewLeadBySelectingDifferentLeadSourceFromDDTest {
	
	@Test
	public void CreateNewLead() throws DocumentException {
		...
		//enter mandatory fields and create lead by selecting different LaedSource from Dropdown
		driver.findElement(By.name("lastname")).sendKeys("Chougole");
		driver.findElement(By.name("company")).sendKeys("PRODUCT");
		
		WebElement selectdropdown = driver.findElement(By.name("leadsource"));
        ...
        Assert.assertTrue(successMsg.contains("Chougole"));
