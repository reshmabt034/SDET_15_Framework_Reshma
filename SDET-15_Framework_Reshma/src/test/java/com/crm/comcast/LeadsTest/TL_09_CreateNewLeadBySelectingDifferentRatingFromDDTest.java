...
public class TL_09_CreateNewLeadBySelectingDifferentRatingFromDDTest {
	...
	public void CreateNewLeadIndustry() throws DocumentException {
		...
		//enter mandatory fields and create lead by selecting different Rating from Dropdown
		driver.findElement(By.name("lastname")).sendKeys("MPatil");
		driver.findElement(By.name("company")).sendKeys("EducationServices");
		
		WebElement selectdropdown = driver.findElement(By.name("rating"));
        ...
        Assert.assertTrue(successMsg.contains("MPatil"));
