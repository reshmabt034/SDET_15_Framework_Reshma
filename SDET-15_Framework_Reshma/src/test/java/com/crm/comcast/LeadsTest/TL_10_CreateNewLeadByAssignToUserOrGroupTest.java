...
public class TL_10_CreateNewLeadByAssignToUserOrGroupTest {
	@Test
	public void CreateNewLeadIndustry() throws DocumentException {
		...
		//enter mandatory fields and create lead by Assign To User/Group
		driver.findElement(By.name("lastname")).sendKeys("Patil2");
		driver.findElement(By.name("company")).sendKeys("PRODUCTITServicesLtd");
		
		WebElement selectdropdown = driver.findElement(By.cssSelector("input[value='T']"));
        ...
        Assert.assertTrue(successMsg.contains("Patil2"));
